...
public class UserConstant {
    ...
    public static final String ALL_USER_CACHE_KEY = "meetfriends:all:users:cache";
    ...
    public static final String CHAT_WITH_AI= "chat_messages_with_ai:senderId:";
